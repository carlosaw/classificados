<div class="container-fluid">
    <div class="jumbotron">
      ...
      <p>E mais de <?php echo  $total_usuarios;?> usúarios cadastrados.</p>
    </div>
          ...
          <form method="GET">
            <div class="form-group">
              ...
              <select id="categoria" name="filtros[categoria]" class="form-control">
                ...
                <?php foreach($categorias as $cat): ?>
                  <option value="<?php echo $cat['id']; ?>" <?php echo($cat[
                    'id']==$filtros['categoria'])?'selected="selected"':''; ?>><?php echo $cat['nome']; ?></option>
            ...
            <div class="form-group">
              ...
              <select id="preco" name="filtros[preco]" class="form-control">
                ...
                <option value="0-50" <?php echo($filtros['preco']=='0-50')?'
                selected="selected"':''; ?>>R$ 0 - 50</option>
                
                <option value="51-100" <?php echo($filtros['preco']=='51-100')?'
                selected="selected"':''; ?>>R$ 51 - 100</option>
                
                <option value="101-200" <?php echo($filtros['preco']=='101-200')?'
                selected="selected"':''; ?>>R$ 101 - 200</option>
               
                <option value="201-500" <?php echo($filtros['preco']=='201-500')?'
                selected="selected"':''; ?>>R$ 201 - 500</option>
              </select>
            </div>
