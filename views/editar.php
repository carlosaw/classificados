	    ...
	    <form method="POST" enctype="multipart/form-data">
	    	<div class="form-group">
	    		...
	    		<select name="categoria" id="categoria" class="form-control">
	    			...
	    			foreach($cats as $cat):
	    				?>
	    				<option value="<?php echo $cat['id']; ?>"<?php echo BASE_URL;?><?php echo ($info['id_categoria']==$cat['id'])?'selected="selected"':'';?>><?php echo ($cat['nome']); ?></option>
	    		...
	    		<div class="panel panel-default">
	    			...
	    			<div class="panel-body">
	    				<?php foreach($info['fotos'] as $foto): ?>
	    					<div class="foto_item">
	    						<img src="<?php echo BASE_URL; ?>assets/images/anuncios/<?php echo $foto['url']; ?>" class="img-thumbnail" border="0" /><br/><br/>
	    						
	    						<a href="excluirFoto?id=<?php echo $foto['id']; ?>" class="btn btn-default">Excluir Imagem</a>
	    					</div>
	    				<?php endforeach; ?>	
	    			</div>
	    		</div> 
